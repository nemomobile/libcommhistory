...
#ifndef UPDATESEMITTER_H
#define UPDATESEMITTER_H
...
class UpdatesEmitter : public QObject
{
    Q_OBJECT
public:
    static QSharedPointer<UpdatesEmitter> instance();
    ~UpdatesEmitter();
...
private:
    ...
    static QWeakPointer<UpdatesEmitter> m_Instance;
};

}

#endif // UPDATESEMITTER_H
